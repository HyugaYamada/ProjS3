...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("khiemnguyen.WebApi.Models.CategoryMenu", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("khiemnguyen.WebApi.Models.FeedBack", b =>
                {
                    b.HasOne("JWTAuth.WebApi.Models.UserInfo", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("khiemnguyen.WebApi.Models.Menu", "Menu")
                        .WithMany()
            ...
            modelBuilder.Entity("khiemnguyen.WebApi.Models.Food", b =>
                {
                    b.HasOne("khiemnguyen.WebApi.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("khiemnguyen.WebApi.Models.Food_in_Menu", b =>
                {
                    b.HasOne("khiemnguyen.WebApi.Models.Food", "Food")
                        .WithMany()
            ...
            modelBuilder.Entity("khiemnguyen.WebApi.Models.Menu", b =>
                {
                    b.HasOne("khiemnguyen.WebApi.Models.CategoryMenu", "CategoryMenu")
                        .WithMany()
            ...
            modelBuilder.Entity("khiemnguyen.WebApi.Models.Order", b =>
                {
                    ...
                    b.HasOne("JWTAuth.WebApi.Models.UserInfo", "UserInfo")
                        .WithMany()
